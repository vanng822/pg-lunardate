...
> Verify with your timezone before relying on it.
...
This target builds the Docker image, starts PostgreSQL, waits for it to become
ready, runs `make installcheck` inside the container, and removes the container
